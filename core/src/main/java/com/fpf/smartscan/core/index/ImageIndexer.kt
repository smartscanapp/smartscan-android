...
class ImageIndexer(
    ...
    override suspend fun onProcess(item: MediaMetadata): Pair<MediaMetadata, Embedding> {
        ...
        val bitmap = getBitmapFromUri(context.applicationContext, contentUri, maxImageSize)
    ...
    suspend fun index(allowedDirs: List<Uri> = emptyList()): ProcessorResult{
        ...
        val idToDateMap = MediaStoreHelper.queryImageIdDateMap(context.applicationContext, allowedDirs)
